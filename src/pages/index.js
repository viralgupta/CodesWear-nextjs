  ...
  return (
    <>
      <Head>
        ...
        <link rel="shortcut icon" href="https://www.codeswear.com/favicon.ico" />
      </Head>
      <main>
        <img src="/home.jpg" alt='/home.jpg' className="-z-0" />
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl title-font mb-2 text-gray-900 font-bold">Wear The Code with CodesWear.com</h1>
