...
const orders = () => {
  ...
  return (
    <div className='container lg:max-w-screen-xl mx-auto'>
      <div className='text-center text-2xl font-bold m-3'>Your Orders</div>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-12 lg:py-20 mx-auto">
          <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="pb-8 flex flex-wrap md:flex-nowrap">
